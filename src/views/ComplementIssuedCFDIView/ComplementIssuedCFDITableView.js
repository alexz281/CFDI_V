import cfdiservices from "@/services/complementissued";
import {
    dateFormatOptions,
...
export default {
    ...
    methods: {
        ...
        exportToExcel() {
            var issued = XLSX.utils.json_to_sheet(this.complementC);
            var wb = XLSX.utils.book_new();
            XLSX.utils.book_append_sheet(wb, issued, "Issued");
            XLSX.writeFile(wb, "Issued.xlsx");
        },
        async getcfdireporcomplemntC() {
            ...
            let res = await cfdiservices.getcfdireporcomplemntC(
                companygroup,
                company,
                cfditype,
                paymentmethod,
            ...
            if (res && res.content) {
                ...
                this.complementC = cfdiresponse.map((report) => {
                    return {
